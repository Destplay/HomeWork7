...
struct AlgoProvider {
    ...
    var searchings: [Algo] {
        return [
            Algo(name: "Linear Search"),
            Algo(name: "Binary Search"),
            Algo(name: "Count Occurrences"),
            Algo(name: "Select Minimum / Maximum"),
            Algo(name: "k-th Largest Element"),
            Algo(name: "Selection Sampling"),
            Algo(name: "Union-Find")
        ]
    }
